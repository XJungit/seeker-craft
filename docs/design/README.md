...
- [mindcraft-parity-audit.md](./mindcraft-parity-audit.md) — Tool coverage vs Mindcraft (37 tools, P48 RecipeBook integration).
- [upgrade-to-mindcraft-parity-2026-07-15.md](./upgrade-to-mindcraft-parity-2026-07-15.md) — Capability comparison & remaining gaps.

See also:
- [`ARCHITECTURE.md`](../../ARCHITECTURE.md) — Layered overview, 13-step main loop, 37 tools, P56-P58 governance.
