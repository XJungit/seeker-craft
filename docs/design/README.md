...
- [mindcraft-parity-audit.md](./mindcraft-parity-audit.md) — Tool coverage vs Mindcraft (54 tools, P48 RecipeBook integration).
...
The architecture evolved: LLM directly controls the bot via 53 atomic tools
(as of v1.0.0, 2026-08-15), following the Mindcraft philosophy where bot tools
