...
pub const RECIPES: &[Recipe] = &[
    ...
    Recipe {
        output: "wooden_sword",
        inputs: &[("oak_planks", 2), ("stick", 1)],
        method: Method::Craft3x3,
    },
    Recipe {
        output: "wooden_shovel",
        inputs: &[("oak_planks", 1), ("stick", 2)],
        method: Method::Craft3x3,
    },
    Recipe {
        output: "wooden_hoe",
        inputs: &[("oak_planks", 2), ("stick", 2)],
        method: Method::Craft3x3,
    },
    // ---- 3×3 石制品 ----
    Recipe {
    ...
    Recipe {
        output: "charcoal",
        inputs: &[("oak_log", 1)],
        method: Method::Smelt { fuel: "oak_log" },
    },
    // ---- 可直接采集的方块 ----
    Recipe {
        output: "oak_log",
